...
export enum StringTemplates {
  ...
  TransferChat = 'ConvTransferTransferChat',
  Participants = 'ConvTransferParticipants',
  Agent = 'ConvTransferAgent',
  Customer = 'ConvTransferCustomer',
  Queue = 'ConvTransferQueue',
  Remove = 'ConvTransferRemove',
  InvitedParticipants = 'ConvTransferInvitedParticipants',
  CancelInvite = 'ConvTransferCancelInvite',
  LeaveChat = 'ConvTransferLeaveChat',
}
